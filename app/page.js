...
export default function Home() {
  return (
    <main className="dark:bg-neutral-900">
      <section id="hero" className="min-h-screen flex flex-col bg-gradient-to-t from-red-200 to-amber-50 dark:from-stone-900 dark:to-stone-700">
        <Navbar />
      ...
      {/* Expertise */}
      <section id="expertise" className="px-8 py-16 bg-rose-gray md:px-30 lg:px-80 dark:bg-neutral-900">
          <h2 className="text-center leading-12 text-rose-950 font-semibold py-6 dark:text-white">Deliver impactful solutions.</h2>
          <p className="text-center leading-7 mb-8 max-w-4xl mx-auto md:text-lg">By aligning technology with business objectives, I drive digital transformation, optimise processes, and enable organisations to achieve sustainable growth while maintaining compliance and security in an evolving IT landscape. Focusing on:</p>
      ...
      {/* Experience */}
      <section id="experience" className="px-8 py-16 md:px-30 lg:px-80">
        ...
        <div className="flex flex-col gap-6 mx-8">
          ...
          {/* RACQ */}
          <div className="rounded-xl shadow-xl p-8 bg-white dark:bg-stone-800 dark:border dark:border-stone-700">
      ...
      {/* Industries */}
      <section id="industries" className="px-8 py-16 bg-rose-gray md:px-30 lg:px-80 dark:bg-neutral-900">
      ...
      {/* Contact */}
      <section id="contact" className="px-8 py-24 md:px-30 lg:px-80 text-center">
        <h2 className="leading-12 text-rose-950 font-semibold dark:text-white">Let's work together.</h2>
        <p className="mt-4 mb-10 text-lg max-w-xl mx-auto">
          Open to new opportunities, collaborations, and conversations. Reach out and I'll get back to you promptly.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a
            href="mailto:jingyang2102@gmail.com"
            className="flex items-center justify-center gap-2 bg-rose-950 hover:bg-rose-800 text-white px-6 py-3 rounded-lg font-medium transition-colors"
          >
            <AiOutlineMail className="text-xl" />
            jingyang2102@gmail.com
          </a>
          <a
            href="https://www.linkedin.com/in/jinggg"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 border-2 border-rose-950 text-rose-950 hover:bg-rose-950 hover:text-white px-6 py-3 rounded-lg font-medium transition-colors dark:border-rose-400 dark:text-rose-400 dark:hover:bg-rose-400 dark:hover:text-black"
          >
